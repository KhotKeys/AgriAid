// Initialize Firebase using the same approach as user-dashboard.js
...
async function initAdminDashboard() {
    ...
    try {
        // Use shared firebase-config.js (AgriAid project)
        console.log('📦 Importing shared firebase-config.js...');
        const fb = await import('./firebase-config.js');
        const app = fb.app;
        auth = fb.auth;
        db = fb.db;

        console.log('✅ Shared Firebase config imported');
